...
class GeneralNonlinearFun(BaseNonlinearFun):
    ...
    def __init__(
        ...
        *,
        ...
        `exponax_spde.nonlin_fun.ConvectionNonlinearFun`). The extension reads
        ...
        !!! warning
            ...
            `exponax_spde.nonlin_fun.ConvectionNonlinearFun` and
            `exponax_spde.nonlin_fun.GradientNormNonlinearFun`, there is no minus.

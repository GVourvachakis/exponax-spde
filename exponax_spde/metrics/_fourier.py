...
def fourier_aggregator(
    ...
    *,
    ...
    While conceptually similar to [`exponax_spde.metrics.spatial_aggregator`][], this
    ...
    !!! info
        ...
        errors) identical to [`exponax_spde.metrics.spatial_aggregator`][] for
...
def fourier_norm(
    ...
    *,
    ...
    While conceptually similar to [`exponax_spde.metrics.spatial_norm`][], this
    function additionally allows filtering specific frequency ranges and to take
    derivatives. In higher dimensions, the derivative contributions (i.e., the
    entries of the gradient) are summed up.
    ...
    !!! tip
        ...
        [`exponax_spde.metrics.mean_metric`][] is provided.
    ...
    produces the same result as [`exponax_spde.metrics.spatial_norm`][] which is a
...
def fourier_MAE(
    ...
    *,
    ...
    While conceptually similar to [`exponax_spde.metrics.MAE`][], this
    ...
    !!! tip
        ...
        a helper for this, [`exponax_spde.metrics.mean_metric`][] is provided.
...
def fourier_nMAE(
    ...
    *,
    ...
    While conceptually similar to [`exponax_spde.metrics.nMAE`][], this
    function is **not** consistent with the `L¹(Ω)` functional norm. However, it
    additionally allows filtering specific frequency ranges and to take
    derivatives. In higher dimensions, the derivative contributions (i.e., the
    entries of the gradient) are summed up.
...
def fourier_MSE(
    ...
    *,
    ...
    [`exponax_spde.metrics.MSE`][] which is a consequence of Parseval's theorem.
...
def fourier_nMSE(
    ...
    *,
    ...
    Under default settings with correctly specified `domain_extent`, this
    function (up to rounding errors) produces the identical result as
    [`exponax_spde.metrics.nMSE`][] which is a consequence of Parseval's theorem.
    However, it additionally allows filtering specific frequency ranges and to
    take derivatives. In higher dimensions, the derivative contributions (i.e.,
    the entries of the gradient) are summed up.
...
def fourier_RMSE(
    ...
    *,
    ...
    Under default settings with correctly specified `domain_extent`, this
    function (up to rounding errors) produces the identical result as
    [`exponax_spde.metrics.RMSE`][] which is a consequence of Parseval's theorem.
    However, it additionally allows filtering specific frequency ranges and to
    take derivatives. In higher dimensions, the derivative contributions (i.e.,
    the entries of the gradient) are summed up.
...
def fourier_nRMSE(
    ...
    *,
    ...
    Under default settings with correctly specified `domain_extent`, this
    function (up to rounding errors) produces the identical result as
    [`exponax_spde.metrics.nRMSE`][] which is a consequence of Parseval's theorem.
    However, it additionally allows filtering specific frequency ranges and to
    take derivatives. In higher dimensions, the derivative contributions (i.e.,
    the entries of the gradient) are summed up.

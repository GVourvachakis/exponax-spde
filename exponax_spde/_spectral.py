...
def build_laplace_operator(
    ...
    *,
    ...
    [`exponax_spde.spectral.build_derivative_operator`], return the Laplace operator.
...
def wavenumber_shape(num_spatial_dims: int, num_points: int) -> tuple[int, ...]:
    ...
    `exponax_spde.fft` which internally performs a real-valued fft
    `jax.numpy.fft.rfftn`).
...
def low_pass_filter_mask(
    ...
    **Returns:**
    ...
    !!! example
        ...
        wn = exponax_spde.spectral.build_wavenumbers(1, 10)
...
def oddball_filter_mask(
    ...
    **Returns:**
    ...
    !!! example
        ...
        mask_even = exponax_spde.spectral.oddball_filter_mask(1, 6)

        # array([[ True,  True,  True, False]])

        mask_odd = exponax_spde.spectral.oddball_filter_mask(1, 7)
...
def build_scaling_array(
    ...
    *,
    ...
    """
    When `exponax_spde.fft` is used, the resulting array in Fourier space represents
    ...
    2. `"reconstruction"`: Technically `"norm_compensation"` should provide an
        ...
        (i.e., what [`exponax_spde.FourierInterpolator`][] does). However, since
        [`exponax_spde.fft`][] uses the real-valued FFT, there is only half of the
...
def get_modes_slices(
    ...
    **Returns:**
    ...
    !!! example
        ...
        slices = exponax_spde.spectral.get_modes_slices(1, 10)
        ...
        slices = exponax_spde.spectral.get_modes_slices(2, 10)
...
def fft(
    ...
    **Returns:**
    ...
    !!! info
        ...
        [`exponax_spde.ifft`][] function applies normalization. To extract the
        amplitude of the coefficients divide by
        `exponax_spde.spectral.build_scaling_array`.
    """
...
def ifft(
    ...
    *,
    ...
    operation of `exponax_spde.fft`. This function is designed for states in
    ...
    **Returns:**
    ...
    !!! info
        ...
        `norm` argument with `norm="backward"`. This means that the forward FFT
        [`exponax_spde.fft`][] function does not apply any normalization to the
        ...
        transform it, consider using [`exponax_spde.spectral.build_scaling_array`][]
...
def get_fourier_coefficients(
    ...
    *,
    ...
    It correctly compensates the scaling used in `exponax_spde.fft` such that the
    ...
    **Arguments:**
    ...
    - `scaling_compensation_mode`: The mode of the scaling array to use to
        ...
        compensation. See also [`exponax_spde.spectral.build_scaling_array`][] for
        more information.
    ...
    **Returns:**
    ...
    !!! warning
        Do not use the results of this function together with the `exponax_spde.viz`
    ...
    !!! tip
        ...
        coef_2d = exponax_spde.spectral.get_fourier_coefficients(state_2d)
        ...
        coef_3d = exponax_spde.spectral.get_fourier_coefficients(
            state_3d, round=None,
        )

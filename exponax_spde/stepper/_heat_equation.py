...
class HeatEquation(BaseStepper):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Timestepper for the d-dimensional (`d ∈ {1, 2, 3}`) heat equation
        on periodic boundary conditions.

        In 1d, the heat equation is given by
        ...
        In higher dimensions, the heat equation can written using the
        Laplacian operator.
        ...
        **Notes:**
        ...
        - Ultimately, only the factor `ν Δt / L²` affects the characteristic
            ...
            [`exponax_spde.stepper.generic.NormalizedLinearStepper`][] with

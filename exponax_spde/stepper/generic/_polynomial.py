...
class GeneralPolynomialStepper(BaseStepper):
    ...
    def __init__(
        ...
        *,
        ...
        exponax_spde.stepper.reaction.FisherKPP(
...
class NormalizedPolynomialStepper(GeneralPolynomialStepper):
    ...
    def __init__(
        ...
        *,
        ...
        See `exponax_spde.stepper.generic.GeneralPolynomialStepper` for more details
...
class DifficultyPolynomialStepper(NormalizedPolynomialStepper):
    ...
    def __init__(
        ...
        *,
        ...
        Different to `exponax_spde.stepper.generic.NormalizedPolynomialStepper`, the

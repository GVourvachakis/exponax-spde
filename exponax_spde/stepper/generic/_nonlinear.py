...
class GeneralNonlinearStepper(BaseStepper):
    ...
    def __init__(
        ...
        *,
        ...
        `exponax_spde.stepper.generic.GeneralPolynomialStepper` (with only the
        coefficient to the quadratic polynomial being set with `b₀`), the
        `exponax_spde.stepper.generic.GeneralConvectionStepper` (with the
        single-channel hack activated via `single_channel=True` and the
        convection scale set with `- b₁`), and the
        `exponax_spde.stepper.generic.GeneralGradientNormStepper` (with the gradient
        norm scale set with `- b₂`).

        !!! warning
            In contrast to the
            `exponax_spde.stepper.generic.GeneralConvectionStepper` and the
            `exponax_spde.stepper.generic.GeneralGradientNormStepper`, the nonlinear
            ...
            `exponax_spde.stepper.generic.GeneralPolynomialStepper` the polynomial
...
class NormalizedNonlinearStepper(GeneralNonlinearStepper):
    ...
    def __init__(
        ...
        *,
        ...
        See `exponax_spde.stepper.generic.GeneralNonlinearStepper` for more details
        ...
        `exponax_spde.stepper.generic.NormalizedPolynomialStepper` (with only the
        coefficient to the quadratic polynomial being set with `b₀`), the
        `exponax_spde.stepper.generic.NormalizedConvectionStepper` (with the
        single-channel hack activated via `single_channel=True` and the
        convection scale set with `- b₁`), and the
        `exponax_spde.stepper.generic.NormalizedGradientNormStepper` (with the
        gradient norm scale set with `- b₂`).

        !!! warning
            In contrast to the
            `exponax_spde.stepper.generic.NormalizedConvectionStepper` and the
            `exponax_spde.stepper.generic.NormalizedGradientNormStepper`, the
            ...
            `exponax_spde.stepper.generic.NormalizedPolynomialStepper` the polynomial
            nonlinearity is already on the right-hand side.)
...
class DifficultyNonlinearStepper(NormalizedNonlinearStepper):
    ...
    def __init__(
        ...
        *,
        ...
        Different to `exponax_spde.stepper.generic.NormalizedNonlinearStepper`, the
        ...
        of the input state (typically `1.0` if one uses the `exponax_spde.ic` random

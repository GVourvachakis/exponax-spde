...
class NormalizedConvectionStepper(GeneralConvectionStepper):
    ...
    def __init__(
        ...
        *,
        ...
        See `exponax_spde.stepper.generic.GeneralConvectionStepper` for more details
...
class DifficultyConvectionStepper(NormalizedConvectionStepper):
    ...
    def __init__(
        ...
        *,
        ...
        Different to `exponax_spde.stepper.generic.NormalizedConvectionStepper`, the
        ...
        if one uses the `exponax_spde.ic` random generators with the `max_one=True`
        argument).

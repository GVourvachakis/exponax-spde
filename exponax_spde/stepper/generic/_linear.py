    ...
    def __init__(
        ...
        **Notes:**
        ...
        - Take care of the signs of coefficients. In contrast to the
            individual linear steppers ([`exponax_spde.stepper.Advection`][],
            [`exponax_spde.stepper.Diffusion`][], etc.), the signs are not
        ...
        - Ultimately, only the factors `a_j Δt / Lʲ` affect the
            ...
            the function
            [`exponax_spde.stepper.generic.normalize_coefficients`][] to obtain
